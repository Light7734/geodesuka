		...
		namespace object {
			...
			*/
			...
			public:
				...
				*/
				virtual math::integer draw(system_display* aTargetSystemDisplay) = 0;
				...
				*/ 
				virtual math::integer draw(system_window* aTargetSystemWindow) = 0;
