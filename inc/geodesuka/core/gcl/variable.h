		...
		namespace gcl {
			...
			public:
				...
				enum class id {
					...
					INTEGER		= SINT32,
					REAL		= FLOAT32,
					NATURAL2 = GL_UNSIGNED_INT_VEC2, NATURAL3 = GL_UNSIGNED_INT_VEC3, NATURAL4 = GL_UNSIGNED_INT_VEC4,
					INTEGER2 = GL_INT_VEC2, INTEGER3 = GL_INT_VEC3, INTEGER4 = GL_INT_VEC4,
					REAL2 = GL_FLOAT_VEC2, REAL3 = GL_FLOAT_VEC3, REAL4 = GL_FLOAT_VEC4,
					REAL2X2 = GL_FLOAT_MAT2, REAL2X3 = GL_FLOAT_MAT2x3, REAL2X4 = GL_FLOAT_MAT2x4,
					REAL3X2 = GL_FLOAT_MAT3x2, REAL3X3 = GL_FLOAT_MAT3, REAL3X4 = GL_FLOAT_MAT3x4,
					REAL4X2 = GL_FLOAT_MAT4x2, REAL4X3 = GL_FLOAT_MAT4x3, REAL4X4 = GL_FLOAT_MAT4
				};
